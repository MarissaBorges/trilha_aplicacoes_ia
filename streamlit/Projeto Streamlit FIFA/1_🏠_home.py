...
if "data" not in st.session_state:
    df_data = pd.read_csv("streamlit\Projeto Streamlit FIFA\datasets\CLEAN_FIFA23_official_data.csv", index_col=0)
...
st.sidebar.markdown("Desenvolvido por [Dev Borges](https://github.com/marissaborges)")
